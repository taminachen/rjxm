...
<body>
	...
	<form id="form1" name="form1" method="post"
		action="${pageContext.request.contextPath }/ReportServlet?method=check&platformID=${reportBean.platformID }">
...
<div>
	<table class="table table-bordered" width="800" border="1">
		...
		<tr>
			...
			<p align="center">
			<input type="radio" id="status1" name="status" value="1" onClick="sele()"> 同意 
			<input type="radio" id="status2" name="status" value="2" onClick="sele2()"> 不同意
			</p>
			<p align="center">&nbsp;</p></td>
		</tr>
		<tr id="tr" style="display: none">
			<td colspan="4"><p align="left"><span class="STYLE2">*</span>审核意见</p></td>
		</tr>
		<tr id="tr2" style="display: none">
			<td colspan="4"><textarea name="suggestion" id="suggestion" class="form-control" rows="8"></textarea></td>
		</tr>
	</table>
